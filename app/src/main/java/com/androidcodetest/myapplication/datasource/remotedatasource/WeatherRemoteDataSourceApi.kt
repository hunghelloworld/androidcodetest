...
interface WeatherRemoteDataSourceApi {
    ...
    suspend fun getWeatherByCity(@Query("q")city:String): Response<WeatherByCity>


    @GET("/data/2.5/weather")
    suspend fun getWeatherByZipCode(@Query("zip")zipCode:String): Response<WeatherByCity>
